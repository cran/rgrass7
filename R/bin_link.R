...
readRAST <- function(vname, cat=NULL, ignore.stderr=get.ignore.stderrOption(), 
    ...
    .Deprecated(new="read_RAST", package="rgrass", old="readRAST",
        msg="Package rgrass7 is transitioning to package rgrass for GRASS GIS 7+.\n'readRAST' is deprecated. Use 'read_RAST' instead.")
...
writeRAST <- function(x, vname, zcol = 1, NODATA=NULL, 
	ignore.stderr = get.ignore.stderrOption(), useGDAL=get.useGDALOption(), overwrite=FALSE, flags=NULL,
        ...
        .Deprecated(new="write_RAST", package="rgrass", old="writeRAST",
